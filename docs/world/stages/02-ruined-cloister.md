...
**Baseline-layout work:** use the [measured geometry example](../examples/v001/02-ruined-cloister-INSTRUCTIONS.md) as the starting point. The dimensions/beats below are an earlier freeform redesign sketch; they do not override the baseline.
