# Pilgrim Road — layout baseline contribution

Use this as the geometry starting point, then make any adjustments in a recorded v002 deviation. [Layout JSON](01-pilgrim-road.json) · [neutral diagram](01-pilgrim-road.svg) · [scrolling preview](preview.html) · [shared workflow](../README.md).

**Bounds 13920 × 1360; 5 rooms, 5 joins.** This example takes priority over the earlier freeform envelope when submitting a baseline-layout PR. It is not the current playable Pilgrim Road or a finished stage.

## Written art direction

Exposed worn limestone approach leading into an abandoned abbey nave; blue-gray moonlight, muted-indigo distance, occasional warm brass braziers, sparse ivy. Upper and lower galleries share the same stone scale.
...
| --- | --- | --- | --- | --- |
| 01-A | (0, 104) | x=0..2848, y=0..640 | 1 | 0 |
| 01-B | (2656, 40) | x=192..6144, y=0..640 | 127 | 8 |
| 01-C | (8800, 680) | x=0..2048, y=0..640 | 39 | 2 |
| 01-D | (8800, 40) | x=0..2048, y=0..640 | 67 | 6 |
| 01-E | (10848, 40) | x=0..3072, y=0..640 | 77 | 6 |
...
| --- | --- | --- | --- | --- |
| 01-join-1 | 01-A → 01-B | scene-door / portal | (2848, 512) | (192, 576) |
| 01-join-2 | 01-B → 01-D | doorway / seam | (6144, 192) | (0, 192) |
| 01-join-3 | 01-D → 01-C | stair-band-transition / seam | (260, 640) | (260, 0) |
| 01-join-4 | 01-C → 01-D | stair-band-transition / seam | (1544, 0) | (1544, 640) |
| 01-join-5 | 01-D → 01-E | doorway / seam | (2048, 192) | (0, 192) |
