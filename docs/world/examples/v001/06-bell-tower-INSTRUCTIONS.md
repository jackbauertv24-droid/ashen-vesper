# Bell Tower — layout baseline contribution

Use this as the geometry starting point, then make any adjustments in a recorded v002 deviation. [Layout JSON](06-bell-tower.json) · [neutral diagram](06-bell-tower.svg) · [scrolling preview](preview.html) · [shared workflow](../README.md).

**Bounds 11944 × 2000; 5 rooms, 6 joins.** This example takes priority over the earlier freeform envelope when submitting a baseline-layout PR. It is not the current playable Pilgrim Road or a finished stage.

## Written art direction

Bell-tower approach and ascending tower galleries: moonlit stone, timber landings, narrow sky gaps, separate bronze bell/supports, sparse warm lamps, a quiet upper arena. Preserve room-to-room turns and vertical transitions.
...
| --- | --- | --- | --- | --- |
| 06-A | (5800, 1320) | x=152..6144, y=0..640 | 12 | 2 |
| 06-B | (3072, 1320) | x=0..2880, y=0..640 | 34 | 8 |
| 06-C | (3072, 680) | x=0..3072, y=0..640 | 47 | 11 |
| 06-D | (0, 680) | x=0..3072, y=0..640 | 12 | 0 |
| 06-E | (0, 40) | x=0..2920, y=0..640 | 69 | 0 |
...
| --- | --- | --- | --- | --- |
| 06-join-1 | 06-A → 06-B | scene-door / portal | (152, 256) | (2880, 256) |
| 06-join-2 | 06-B → 06-C | stair-band-transition / seam | (2688, 0) | (2688, 640) |
| 06-join-3 | 06-C → 06-B | stair-band-transition / seam | (1284, 640) | (1284, 0) |
| 06-join-4 | 06-B → 06-C | stair-band-transition / seam | (384, 0) | (384, 640) |
| 06-join-5 | 06-C → 06-D | doorway / seam | (0, 256) | (3072, 256) |
| 06-join-6 | 06-D → 06-E | stair-band-transition / seam | (2440, 0) | (2440, 640) |
