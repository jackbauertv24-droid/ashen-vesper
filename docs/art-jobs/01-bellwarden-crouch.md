...
- Crouched head should be near source y=272; soles y=464. Target height about 192px, or 72 runtime units. Keep a natural bent-knee silhouette, with unchanged head and torso proportions. The earlier 56-unit target was too compressed and is superseded.
- Contact sword extends rightward from the body. Match the current low attack region: x=8..115, y=-52..-7 relative to player feet. Keep tip at least 4px from the cell edge.
