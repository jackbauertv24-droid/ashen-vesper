...
**Maintainers:** [open findings and ideas](docs/HANDOFF.md) — what is known to be wrong, what was deliberately left alone, and what to do first on picking the project back up.
